...
class RadioButtonRN extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (this.state.activeIndex === -1 && this.props.initial == 0) {
            const initialActive = this.props.initial;
        ...
        if (this.props.initial !== prevProps.initial && this.state.activeIndex === -1 ) {
            const initialActive = this.props.initial;
            this._changeRadio(this.props.data[initialActive], initialActive);
        }
    ...
    _changeRadio(item, activeIndex) {
        ...
        this.props.selectedBtn(activeIndex, item);
    }
	...
	render() {
        ...
        let { boxStyle, style, circleSize, textStyle, data, icon, activeColor, deactiveColor, boxActiveBgColor, boxDeactiveBgColor, box, textColor, textInActiveColor } = this.props;
                    ...
                    return (
                        ...
                        >
                            ...
                            <View style={[styles.centerProductBox]}>
                                <Text style={[{
                                    color: activeIndex === index ? textColor : textInActiveColor
                                }, textStyle]}>
                                    {(item.attr_name)}
                                </Text>
                            </View>
