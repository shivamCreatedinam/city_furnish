...
const ScrollableTabView = createReactClass({
  ...
  render() {
    ...
    let tabBarProps = {
      ...
      tabs: this._children().map(
        (child) => {
          if (child.props.isImageVisible == true || child.props.isImageVisible == false) {
            return {
              'label': child.props.tabLabel, 'img': child.props.imgUrl ? child.props.imgUrl : "",
              'isImageVisible': child.props.isImageVisible ? child.props.isImageVisible : ""
            }
          } else {
