...
function LoginShowAlertModal(props) {
...
function renderViewTypes(props) {
    const { titlemodel, descriptionModel, onClickLoginShowAlerPicktType, onPressBackDrop } = props
    return (
        <View style={{
            borderRadius: 8,
            ...
            <TouchableOpacity style={{ height: 55, width: '100%', alignItems: 'center', justifyContent: 'center' }}
             onPress={() => { onClickLoginShowAlerPicktType('ok') }}>
                <Text style={{
                    color: resources.colors.textBlack,
                    fontSize: 20,
                    fontFamily: resources.fonts.medium,
