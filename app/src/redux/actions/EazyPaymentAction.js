...
export const hitEazyPaymentRazorpayApi = (orderId, paymentType) =>
    (dispatch) => {
        return new Promise((resolve, reject) => {
            let appUser = AppUser.getInstance()
            let token = appUser.token
...
export const hitEazyPaymentRazorpaySuccessApi = (razorpayPaymentId, razorpayOrderID, razorpaySignature, authRazorpayOrderID, customerId, paymentType) =>
    (dispatch) => {
        return new Promise((resolve, reject) => {
            let appUser = AppUser.getInstance()
            let token = appUser.token
...
export const hitEazyPaymentNACHRazorpayApi = (orderID, accountNumber, ifscCode, beneficiaryName) =>
    (dispatch) => {
        return new Promise((resolve, reject) => {
            let appUser = AppUser.getInstance()
            let token = appUser.token
