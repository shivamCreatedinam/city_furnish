...
export declare type OpenGraphProperties = {
    [key: string]: OpenGraphValue;
};
export declare type OpenGraphValue = {
    type: OpenGraphValueType;
    value: unknown;
};
export declare type OpenGraphValueType = 'number' | 'open-graph-object' | 'photo' | 'string';
/**
 * Represents an interface for adding and retrieving values to open graph objects and actions.
 */
declare class ShareOpenGraphValueContainer {
