...
declare const _default: {
     ...
     */
    logPurchase(purchaseAmount: number, currencyCode: string, parameters?: Params | undefined): void;
    /**
     * Logs an app event that tracks that the application was open via Push Notification.
     */
    logPushNotificationOpen(payload?: Record<string, string | number> | undefined): void;
    /**
     ...
     */
    logProductItem(itemID: string, availability: ProductAvailability, condition: ProductCondition, description: string, imageLink: string, link: string, title: string, priceAmount: number, currency: string, gtin?: string | undefined, mpn?: string | undefined, brand?: string | undefined, parameters?: Params | undefined): void;
    /**
